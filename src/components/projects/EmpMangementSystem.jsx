  ...
  return (
    <div className="border p-3 rounded-md border-foreground/20 flex flex-col gap-3 bg-black/5">
      ...
      <div className="flex justify-center gap-4 border border-foreground/20 rounded-2xl p-2">
        <img src={emp} alt="" className="rounded-xl w-[90%]" loading="lazy" />
      </div>
      {/* badge */}
      ...
      <div>
        <p className="text-foreground/70 text-sm leading-8 tracking-wide">
          A real-time task management system where admins can assign tasks to
          logged-in employees and set priority levels. Employees can accept or
          reject tasks, update status (pending, rejected, completed), and track
          progress instantly through real-time updates. The application includes
          search and filtering features, allowing users to organize tasks based
          on priority and status for better workflow management.
        </p>
      </div>
